...
MUX_CFG_34XX("T8_LCD_LED_PWM",			0x0B6, OMAP34XX_MUX_MODE3 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
MUX_CFG_34XX("T8_LCD_LED_PWM_OFFMODE",		0x0B6, OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN | OMAP34XX_PIN_OFF_NONE)

/* SPI2  - SIRLOIN_3630 LCD  */
MUX_CFG_34XX("AA3_3430_LCD_SPI2_CLK",		0x1D6, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE)
MUX_CFG_34XX("Y2_3430_LCD_SPI2_O",		0x1D8, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE)
MUX_CFG_34XX("Y3_3430_LCD_SPI2_I",		0x1DA, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE)
MUX_CFG_34XX("Y4_3430_LCD_SPI2_CS0",		0x1DC, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE)
MUX_CFG_34XX("Y4_3430_LCD_SPI2_CS0_OFF",	0x1DC, OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLUP | OMAP34XX_PIN_OFF_NONE)
#else
...
/* SPI3 - non-3630 SIRLOIN LCD SPI3. */
...
MUX_CFG_34XX("AD25_3430_UART2_RX",		0x17a, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT  | OMAP34XX_PIN_OFF_NONE | OMAP34XX_PIN_OFF_WAKEUPENABLE )
  ...
  MUX_CFG_34XX("N28_WL_SD0_CLK",		0x144, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_OUTPUT_PULLUP | OMAP34XX_PIN_OFF_NONE)
  MUX_CFG_34XX("M27_WL_SD0_CMD",		0x146, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE) /* has ext PU 10K on VIO */
  MUX_CFG_34XX("N27_WL_SD0_D0",			0x148, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE) /* has ext PU 100K on VIO */
  MUX_CFG_34XX("N26_WL_SD0_D1",			0x14A, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE) /* has ext PU 100K on VIO */
  MUX_CFG_34XX("N25_WL_SD0_D2",			0x14C, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE) /* has ext PU 100K on VIO */
  MUX_CFG_34XX("P28_WL_SD0_D3",			0x14E, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE) /* has ext PU 100K on VIO */
  MUX_CFG_34XX("P27_WL_IRQ",			0xA56, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT  | OMAP34XX_PIN_OFF_NONE | OMAP34XX_PIN_OFF_WAKEUPENABLE)
  MUX_CFG_34XX("P26_WL_RST_nPWD",		0xA54, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_NONE)

  #ifdef CONFIG_CORE_OFF
    MUX_CFG_34XX("P26_WL_RST_nPWD_OFFMODE_HIGH",0xA54, OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLUP   | OMAP34XX_PIN_OFF_NONE)
    MUX_CFG_34XX("P26_WL_RST_nPWD_OFFMODE_LOW",	0xA54, OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN | OMAP34XX_PIN_OFF_NONE)
  #endif
   MUX_CFG_34XX("R27_NC",			0x154, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP)
   MUX_CFG_34XX("R25_NC",			0x156, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP)
#else
...
#ifdef CONFIG_MACH_SIRLOIN_3630
  MUX_CFG_34XX("AC3_BT_nRST",			0x1D0, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_NONE)
  #ifdef CONFIG_CORE_OFF
    MUX_CFG_34XX("AC3_BT_nRST_OFFMODE_HIGH",	0x1D0, OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLUP   | OMAP34XX_PIN_OFF_NONE)
    MUX_CFG_34XX("AC3_BT_nRST_OFFMODE_LOW",	0x1D0, OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN | OMAP34XX_PIN_OFF_NONE)
  #endif
#else
...
#ifdef CONFIG_MACH_SIRLOIN_3630
MUX_CFG_34XX("T2_3430_GPIO49",			0x0A8, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLDOWN | OMAP34XX_PIN_OFF_INPUT_PULLDOWN)
#else
...
#ifdef CONFIG_MACH_SIRLOIN_3630
MUX_CFG_34XX("Y21_GPIO_156_OPTICAL_SLIDER",	0x18C, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT_PULLUP | OMAP34XX_PIN_OFF_NONE)
#else
...
#if defined(CONFIG_MACH_SIRLOIN_3630)

/* Headset shutdown */
MUX_CFG_34XX("C26_3430_GPIO_110",		0x12C, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_NONE)
MUX_CFG_34XX("C26_3430_GPIO_110_OFFMODE",	0x12C, OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT_PULLDOWN | OMAP34XX_PIN_OFF_NONE)
/* Headset button PWM interrupt */
MUX_CFG_34XX("B25_3430_GPIO_109",		0x12A, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_INPUT_PULLUP | OMAP34XX_PIN_OFF_WAKEUPENABLE)
/* Headset button PWM */
MUX_CFG_34XX("R1_3430_MIC_ANS_ON",		0x0A4, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT_PULLUP | OMAP34XX_PIN_OFF_NONE) /* to wake up from suspend */
MUX_CFG_34XX("R1_3430_MIC_ANS_OFF",		0x0A4, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT_PULLDOWN | OMAP34XX_PIN_OFF_INPUT_PULLDOWN) /* to wake up from suspend */
 ...
 */
#ifdef CONFIG_MACH_SIRLOIN_3630
MUX_CFG_34XX("D25_3430_GPIO_126",		0x132, OMAP34XX_MUX_MODE7 | OMAP34XX_PIN_INPUT)
MUX_CFG_34XX("K2_GPMC_D9_GPIO_45",		0x0A0, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
#else
MUX_CFG_34XX("D25_3430_GPIO_126",		0x132, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT | OMAP34XX_PIN_OFF_OUTPUT_LOW)
...
/* MMC Flash */
#ifdef CONFIG_MACH_SIRLOIN_3630
/* On SIRLOIN-3630 flash is on MMC2 */
MUX_CFG_34XX("AE2_MMC2_CLK",			0x158, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_INPUT_PULLUP)
MUX_CFG_34XX("AG5_MMC2_CMD",			0x15A, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE) /* has ext PU 10K on VIO */
MUX_CFG_34XX("AH5_MMC2_DAT0",			0x15C, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE) /* has ext PU 100K on VIO */
MUX_CFG_34XX("AH4_MMC2_DAT1",			0x15E, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE) /* has ext PU 100K on VIO */
MUX_CFG_34XX("AG4_MMC2_DAT2",			0x160, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE) /* has ext PU 100K on VIO */
MUX_CFG_34XX("AF4_MMC2_DAT3",			0x162, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE) /* has ext PU 100K on VIO */
MUX_CFG_34XX("AE4_MMC2_DAT4",			0x164, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_INPUT_PULLUP)
MUX_CFG_34XX("AH3_MMC2_DAT5",			0x166, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_INPUT_PULLUP)
MUX_CFG_34XX("AF3_MMC2_DAT6",			0x168, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_INPUT_PULLUP)
MUX_CFG_34XX("AE3_MMC2_DAT7",			0x16A, OMAP34XX_MUX_MODE0 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_INPUT_PULLUP)
#else
/* On SIRLOIN flash is on MMC1 */
...
#if defined(CONFIG_MACH_SIRLOIN) || defined(CONFIG_MACH_SIRLOIN_3630)
/* Boot mode pins */
MUX_CFG_34XX("AH26_SYS_BOOT0",			0xA0A, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE) /* has ext PD 10K */
MUX_CFG_34XX("AG26_SYS_BOOT1",			0xA0C, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE) /* has ext PU 10K */
MUX_CFG_34XX("AE14_SYS_BOOT2",			0xA0E, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE) /* has ext PD 10K */
MUX_CFG_34XX("AF18_SYS_BOOT3",			0xA10, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE) /* has ext PD 10K */
MUX_CFG_34XX("AF19_SYS_BOOT4",			0xA12, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE) /* has ext PU 10K */
MUX_CFG_34XX("AE21_SYS_BOOT5",			0xA14, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE) /* has ext PU 10K */
MUX_CFG_34XX("AF21_SYS_BOOT6",			0xA16, OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_INPUT | OMAP34XX_PIN_OFF_NONE) /* has ext PU 10K */
