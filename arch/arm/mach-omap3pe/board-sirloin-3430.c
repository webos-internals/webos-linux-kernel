/*
 * arch/arm/mach-omap2/board-sirloin-3430.c
 *
 * This file contains code specific to the Sirloin board.
 *
 * Copyright (C) 2007-2008 Palm, Inc.
 *
 * Based on from board-sirloin-3430.c
 *
...
static struct i2c_board_info accelerometer_i2c_board_info = {
...
#if defined(CONFIG_ACCELEROMETER_KXSD9) \
	|| defined(CONFIG_ACCELEROMETER_KXSD9_MODULE)
	i2c_register_board_info( 3, &accelerometer_i2c_board_info, 1);
#endif
	}
...
static struct controller_platform_data board_lcd_controller_data = {
	...
	.sdi_pll_lock_method	= DSS_PLL_CONTROL_LOCKSEL,
...
#ifdef CONFIG_HRES_COUNTER
static struct hres_counter_platform_data omap_hres_counter_pdata = {
	.init_timer = omap_hres_timer_init,
	.release_timer = omap_hres_timer_release,
	.suspend_timer = omap_hres_timer_suspend,
	.resume_timer = omap_hres_timer_resume,
	.read_timer = omap_hres_timer_read,
	.convert_timer = omap_hres_timer_convert,
};
...
static struct platform_device hres_counter_device = {
	...
	.id = -1,
	.dev = {
		.platform_data = &omap_hres_counter_pdata,
	},
};
#endif
