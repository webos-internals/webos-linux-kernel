...
#define GSBI11_UARTDM_ACTIVE \
	GPIOMUX_CFG(GPIOMUX_FUNC_2, GPIOMUX_DRV_8MA, GPIOMUX_PULL_NONE)
#define GSBI11_UARTDM_OUT_ACTIVE GPIOMUX_DCFG(\
	GPIOMUX_FUNC_2, GPIOMUX_DRV_8MA, GPIOMUX_PULL_NONE, GPIOMUX_OUT_LOW)
#define GSBI11_UARTDM_SUSPENDED \
...
#define GSBI5_ACTIVE_CFG \
	GPIOMUX_CFG(GPIOMUX_FUNC_1, GPIOMUX_DRV_8MA, 0)
#define GSBI5_SUSPEND_CFG   GPIO_IN_2M_PD
...
#define COVER_DET_PIN_CFG GPIO_IN_2M_PN
#define SDC3_DET_PIN_CFG  GPIO_IN_2M_PN
...
static struct msm_gpiomux_config msm8x60_isp_usb_configs_proto[] __initdata = {
	GPIOMUX_ACT_SUSP_DEF(ISP1763_INT_GPIO, GPIO_IN_2M_PU, GPIO_IN_2M_PU),
	GPIOMUX_ACT_SUSP_DEF(ISP1763_DACK_GPIO, GPIO_OUTH_2M_PN, GPIO_OUTH_2M_PN),
	GPIOMUX_ACT_SUSP_DEF(ISP1763_DREQ_GPIO, GPIO_IN_2M_PD, GPIO_IN_2M_PD),
	GPIOMUX_ACT_SUSP_DEF(ISP1763_RST_GPIO, GPIO_OUTH_8M_PN, GPIO_OUTH_2M_PN),
	GPIOMUX_ACT_SUSP_DEF(GPIO_3G_3V3_EN_PROTO, GPIO_OUTL_2M_PN, GPIO_OUTH_2M_PN),
	GPIOMUX_ACT_SUSP_DEF(GPIO_3G_DISABLE_N, GPIO_OUTH_2M_PN, GPIO_OUTH_2M_PN),
	GPIOMUX_ACT_SUSP_DEF(GPIO_3G_WAKE_N, GPIO_IN_8M_PU, GPIO_IN_2M_PU),
	GPIOMUX_ACT_SUSP_DEF(GPIO_3G_UIM_CD_N, GPIO_IN_2M_PU, GPIO_IN_2M_PU),
};
...
static struct msm_gpiomux_config msm8x60_uart_configs[] __initdata = {
	...
	{ /* BRCM4751_UART_RFR_GPIO */
		.gpio      = BRCM4751_UART_RFR_GPIO,
		.settings = {
			[GPIOMUX_ACTIVE]    = GSBI11_UARTDM_OUT_ACTIVE,
			[GPIOMUX_SUSPENDED] = GSBI11_UARTDM_SUSPENDED,
		},
	},
	{ /* BRCM4751_UART_CTS_GPIO */
		.gpio      = BRCM4751_UART_CTS_GPIO,
		.settings = {
			[GPIOMUX_ACTIVE]    = GSBI11_UARTDM_ACTIVE,
			[GPIOMUX_SUSPENDED] = GSBI11_UARTDM_SUSPENDED,
		},
	},
	{ /* BRCM4751_UART_RX_GPIO */
		.gpio      = BRCM4751_UART_RX_GPIO,
		.settings = {
			[GPIOMUX_ACTIVE]    = GSBI11_UARTDM_ACTIVE,
			[GPIOMUX_SUSPENDED] = GSBI11_UARTDM_SUSPENDED,
		},
	},
	{ /* BRCM4751_UART_TX_GPIO */
		.gpio      = BRCM4751_UART_TX_GPIO,
		.settings = {
			[GPIOMUX_ACTIVE]    = GSBI11_UARTDM_OUT_ACTIVE,
			[GPIOMUX_SUSPENDED] = GSBI11_UARTDM_SUSPENDED,
		},
...
static struct msm_gpiomux_config msm8x60_uart_3g_configs[] __initdata = {
	{ /* UARTDM_TX */
		.gpio      = 53,
		.settings = {
			[GPIOMUX_ACTIVE]    = UART1DM_OUT_ACTIVE,
...
static struct msm_gpiomux_config msm8x60_spi_configs[] __initdata = {
	/* GSBI5_SPI_OUT */
	{
		.gpio      = 49,
		.settings = {
...
static struct msm_gpiomux_config msm8x60_cam_configs[] __initdata = {
    GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_CAM_I2C_DATA,  CAM_F1_OUTH_8M_PN, GPIO_IN_2M_PU),
    GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_CAM_I2C_CLK, CAM_F1_OUTH_8M_PN, GPIO_IN_2M_PU),
    GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_CAMIF_MCLK,  CAM_F1_OUTL_8M_PN, GPIO_IN_2M_PD),
    GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_WEBCAM_PWDN, GPIO_OUTH_8M_PN, GPIO_OUTH_2M_PN),
    GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_WEBCAM_FLASH, GPIO_OUTL_8M_PN, GPIO_OUTL_2M_PN),
};

static struct msm_gpiomux_config msm8x60_cam_configs_evt1[] __initdata = {
    GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_CAM_I2C_DATA,  CAM_F1_OUTH_8M_PN, GPIO_IN_2M_PU),
    GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_CAM_I2C_CLK, CAM_F1_OUTH_8M_PN, GPIO_IN_2M_PU),
    GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_CAMIF_MCLK,  CAM_F1_OUTL_8M_PN, GPIO_IN_2M_PD),
    GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_WEBCAM_PWDN, GPIO_OUTH_8M_PN, GPIO_OUTH_2M_PN),
    GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_WEBCAM_FLASH_EVT1, GPIO_OUTL_8M_PN, GPIO_OUTL_2M_PN),
};
...
static struct msm_gpiomux_config msm8x60_charger_cfgs[] __initdata = {
	GPIOMUX_ACT_SUSP_DEF(MAX8903B_GPIO_DC_OK, GPIO_IN_8M_PK, GPIO_IN_8M_PK),
	GPIOMUX_ACT_SUSP_DEF(MAX8903B_GPIO_STATUS_N, GPIO_IN_8M_PK, GPIO_IN_8M_PK),
	GPIOMUX_ACT_SUSP_DEF(MAX8903B_GPIO_FAULT_N,  GPIO_IN_8M_PK, GPIO_IN_8M_PK),
...
#define PROXIMITY_GPIOCFG GPIOMUX_DCFG(\
	GPIOMUX_FUNC_1, GPIOMUX_DRV_8MA, GPIOMUX_PULL_NONE, GPIOMUX_OUT_HIGH)

static struct msm_gpiomux_config msm8x60_proximity_cfgs[] __initdata = {
	GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_PROX_INT, GPIO_IN_2M_PN, GPIO_IN_2M_PN),
};

static struct msm_gpiomux_config msm8x60_sensor_cfgs[] __initdata = {
	GPIOMUX_SUSP_DEF(SHORTLOIN_GYRO_INT, GYRO_PIN_CFG),
};

/* cover detect */
static struct msm_gpiomux_config msm8x60_cover_det_cfgs[] __initdata = {
	GPIOMUX_SUSP_DEF(SHORTLOIN_COVER_DET_INT, COVER_DET_PIN_CFG),
};


/* sdc3 */
#ifdef CONFIG_MMC_MSM_SDC3_SUPPORT
static struct msm_gpiomux_config msm8x60_sdc3_cfgs[] __initdata = {
	GPIOMUX_SUSP_DEF(SHORTLOIN_SDC3_DET_INT, SDC3_DET_PIN_CFG),
};
#endif
...
static struct msm_gpiomux_config msm8x60_wlan_configs[] __initdata = {
	...
	GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_GPIO_WL_HOST_WAKE, \
			GPIO_IN_8M_PD, GPIO_IN_8M_PD),

	GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_GPIO_HOST_WAKE_WL, \
			GPIO_OUTH_8M_PN, GPIO_OUTH_2M_PN),

	GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_GPIO_WLAN_RST_N, \
...
#define SHORTLOIN_A6_TCK_ACTIVE_CFG GPIO_OUTH_8M_PN
#define SHORTLOIN_A6_TCK_SUSPENDED_CFG GPIO_IN_2M_PU

#define SHORTLOIN_A6_WAKEUP_ACTIVE GPIO_OUTL_8M_PN
#define SHORTLOIN_A6_WAKEUP_SUSPENDED_CFG GPIO_OUTL_2M_PN

#define SHORTLOIN_A6_TDIO_ACTIVE_CFG GPIO_OUTH_8M_PU
#define SHORTLOIN_A6_TDIO_SUSPENDED_CFG GPIO_IN_2M_PU

#define SHORTLOIN_A6_MSM_IRQ_ACTIVE_CFG GPIO_IN_8M_PU
#define SHORTLOIN_A6_MSM_IRQ_SUSPENDED_CFG GPIO_IN_2M_PU


/* a6 */
static struct msm_gpiomux_config msm8x60_a6_configs[] __initdata = {
	GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_A6_0_TCK, \
			SHORTLOIN_A6_TCK_ACTIVE_CFG, SHORTLOIN_A6_TCK_SUSPENDED_CFG),

	GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_A6_0_WAKEUP, \
			SHORTLOIN_A6_WAKEUP_ACTIVE, SHORTLOIN_A6_WAKEUP_SUSPENDED_CFG),

	GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_A6_0_TDIO, \
			SHORTLOIN_A6_TDIO_ACTIVE_CFG, SHORTLOIN_A6_TDIO_SUSPENDED_CFG),

	GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_A6_0_MSM_IRQ, \
			SHORTLOIN_A6_MSM_IRQ_ACTIVE_CFG, SHORTLOIN_A6_MSM_IRQ_SUSPENDED_CFG),

	GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_A6_1_TCK, \
			SHORTLOIN_A6_TCK_ACTIVE_CFG, SHORTLOIN_A6_TCK_SUSPENDED_CFG),

	GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_A6_1_WAKEUP, \
			SHORTLOIN_A6_WAKEUP_ACTIVE, SHORTLOIN_A6_WAKEUP_SUSPENDED_CFG),

	GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_A6_1_TDIO, \
			SHORTLOIN_A6_TDIO_ACTIVE_CFG, SHORTLOIN_A6_TDIO_SUSPENDED_CFG),

	GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_A6_1_MSM_IRQ, \
			SHORTLOIN_A6_MSM_IRQ_ACTIVE_CFG, SHORTLOIN_A6_MSM_IRQ_SUSPENDED_CFG),
};

/* a6 */
static struct msm_gpiomux_config msm8x60_a6_configs_evt1[] __initdata = {
	GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_A6_0_TCK_EVT1, \
			SHORTLOIN_A6_TCK_ACTIVE_CFG, SHORTLOIN_A6_TCK_SUSPENDED_CFG),
	...
	GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_A6_0_MSM_IRQ_EVT1, \
			SHORTLOIN_A6_MSM_IRQ_ACTIVE_CFG, SHORTLOIN_A6_MSM_IRQ_SUSPENDED_CFG),
	...
	GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_A6_1_MSM_IRQ_EVT1, \
			SHORTLOIN_A6_MSM_IRQ_ACTIVE_CFG, SHORTLOIN_A6_MSM_IRQ_SUSPENDED_CFG),
};
#endif
...
static struct msm_gpiomux_config msm8x60_aud_configs[] __initdata = {
	GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_AUD_LDO1_EN, \
			GPIO_OUTL_8M_PN, GPIO_OUTH_2M_PN),

	GPIOMUX_ACT_SUSP_DEF(SHORTLOIN_AUD_LDO2_EN, \
			GPIO_OUTL_8M_PN, GPIO_OUTH_2M_PN),
};
#endif
...
shortloin_gpiomux_cfgs[] __initdata = {
	...
	{msm8x60_cover_det_cfgs, ARRAY_SIZE(msm8x60_cover_det_cfgs)},
#ifdef CONFIG_MMC_MSM_SDC3_SUPPORT
	{msm8x60_sdc3_cfgs, ARRAY_SIZE(msm8x60_sdc3_cfgs)},
#endif
#ifdef CONFIG_KEYBOARD_GPIO_PE
...
#endif
#if defined(CONFIG_SPI_QUP) || defined(CONFIG_SPI_QUP_MODULE)
	{msm8x60_spi_configs, ARRAY_SIZE(msm8x60_spi_configs)},
#endif
...
struct msm_gpiomux_configs
shortloin_3g_gpiomux_cfgs[] __initdata = {
	{msm8x60_pmic_configs, ARRAY_SIZE(msm8x60_pmic_configs)},
	{msm8x60_uart_3g_configs, ARRAY_SIZE(msm8x60_uart_3g_configs)},
	{msm8x60_bt_configs, ARRAY_SIZE(msm8x60_bt_configs)},
	{msm8x60_wlan_configs, ARRAY_SIZE(msm8x60_wlan_configs)},
	{msm8x60_lcdc_configs, ARRAY_SIZE(msm8x60_lcdc_configs)},
	{msm8x60_sensor_cfgs, ARRAY_SIZE(msm8x60_sensor_cfgs)},
...
#endif
	{msm8x60_gsbi_configs, ARRAY_SIZE(msm8x60_gsbi_configs)},
	{msm8x60_proximity_cfgs,ARRAY_SIZE(msm8x60_proximity_cfgs)},
	{msm8x60_system_gpio_cfgs,ARRAY_SIZE(msm8x60_system_gpio_cfgs)},
#if defined (CONFIG_TOUCHSCREEN_CY8CTMA395) \
	|| defined (CONFIG_TOUCHSCREEN_CY8CTMA395_MODULE)
	{ctp_configs, ARRAY_SIZE(ctp_configs)},
...
struct msm_gpiomux_configs
shortloin_3g_gpiomux_cfgs_evt1[] __initdata = {
	{msm8x60_pmic_configs, ARRAY_SIZE(msm8x60_pmic_configs)},
	{msm8x60_uart_configs, ARRAY_SIZE(msm8x60_uart_configs)},
	{msm8x60_bt_configs, ARRAY_SIZE(msm8x60_bt_configs)},
	{msm8x60_wlan_configs, ARRAY_SIZE(msm8x60_wlan_configs)},
...
#endif
#ifdef CONFIG_A6
	{msm8x60_a6_configs_evt1, ARRAY_SIZE(msm8x60_a6_configs_evt1)},
#endif
#ifdef CONFIG_WEBCAM_MT9M113
	{msm8x60_cam_configs_evt1, ARRAY_SIZE(msm8x60_cam_configs_evt1)},
#endif
#ifdef CONFIG_MSM8X60_AUDIO
	{msm8x60_aud_configs, ARRAY_SIZE(msm8x60_aud_configs)},
	{msm8x60_aux_pcm_configs, ARRAY_SIZE(msm8x60_aux_pcm_configs)},
...
struct msm_gpiomux_configs
shortloin_3g_gpiomux_cfgs_proto[] __initdata = {
	{msm8x60_pmic_configs, ARRAY_SIZE(msm8x60_pmic_configs)},
	{msm8x60_uart_configs, ARRAY_SIZE(msm8x60_uart_configs)},
	{msm8x60_bt_configs, ARRAY_SIZE(msm8x60_bt_configs)},
	{msm8x60_wlan_configs, ARRAY_SIZE(msm8x60_wlan_configs)},
...
#endif
#ifdef CONFIG_USB_PEHCI_HCD
	{msm8x60_isp_usb_configs_proto, ARRAY_SIZE(msm8x60_isp_usb_configs_proto)},
	{msm8x60_ebi2_configs, ARRAY_SIZE(msm8x60_ebi2_configs)},
#endif
#if defined(CONFIG_SPI_QUP) || defined(CONFIG_SPI_QUP_MODULE)
	{msm8x60_spi_configs, ARRAY_SIZE(msm8x60_spi_configs)},
