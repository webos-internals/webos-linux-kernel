...
static struct msm_gpiomux_config msm8x60_cam_configs[] __initdata = {
	GPIOMUX_ACT_SUSP_DEF(CRESPO_CAM_I2C_DATA,  CAM_F1_OUTH_8M_PN, GPIO_IN_2M_PU),
	GPIOMUX_ACT_SUSP_DEF(CRESPO_CAM_I2C_CLK, CAM_F1_OUTH_8M_PN, GPIO_IN_2M_PU),
	GPIOMUX_ACT_SUSP_DEF(CRESPO_CAMIF_MCLK,  CAM_F1_OUTL_8M_PN, GPIO_IN_2M_PD),
};
#endif
...
static struct msm_gpiomux_config msm8x60_kbdgpio_cfgs[] __initdata = {
	{
		.gpio = CORE_NAVI_GPIO,
		.settings = {
			[GPIOMUX_SUSPENDED] = KEYBOARD_GPIO_CFG,
		},
	},
...
#define PROXIMITY_GPIOCFG GPIOMUX_DCFG(\
	GPIOMUX_FUNC_3, GPIOMUX_DRV_8MA, GPIOMUX_PULL_NONE, GPIOMUX_OUT_LOW)

static struct msm_gpiomux_config msm8x60_proximity_i2c_cfgs[] __initdata = {
	GPIOMUX_SUSP_DEF(CRESPO_PROX_I2C_DATA, PROXIMITY_GPIOCFG),
	GPIOMUX_SUSP_DEF(CRESPO_PROX_I2C_CLK, PROXIMITY_GPIOCFG),
};

static struct msm_gpiomux_config msm8x60_sensor_cfgs[] __initdata = {
	GPIOMUX_SUSP_DEF(CRESPO_GYRO_INT, GYRO_PIN_CFG),
};

/* cover detect */
static struct msm_gpiomux_config msm8x60_cover_det_cfgs[] __initdata = {
	GPIOMUX_SUSP_DEF(CRESPO_COVER_DET_INT, COVER_DET_PIN_CFG),
};
...
static struct msm_gpiomux_config msm8x60_sdc3_cfgs[] __initdata = {
	GPIOMUX_SUSP_DEF(CRESPO_SDC3_DET_INT, SDC3_DET_PIN_CFG),
};
#endif
...
static struct msm_gpiomux_config msm8x60_wlan_configs[] __initdata = {
	...
	GPIOMUX_ACT_SUSP_DEF(CRESPO_GPIO_WL_HOST_WAKE, \
			GPIO_IN_8M_PD, GPIO_IN_8M_PD),

	GPIOMUX_ACT_SUSP_DEF(CRESPO_GPIO_HOST_WAKE_WL, \
			GPIO_OUTH_8M_PN, GPIO_OUTH_2M_PN),

	GPIOMUX_ACT_SUSP_DEF(CRESPO_GPIO_WLAN_RST_N, \
...
#define CRESPO_A6_TCK_ACTIVE_CFG GPIO_OUTH_8M_PN
#define CRESPO_A6_TCK_SUSPENDED_CFG GPIO_IN_2M_PU

#define CRESPO_A6_WAKEUP_ACTIVE GPIO_OUTL_8M_PN
#define CRESPO_A6_WAKEUP_SUSPENDED_CFG GPIO_OUTL_2M_PN

#define CRESPO_A6_TDIO_ACTIVE_CFG GPIO_OUTH_8M_PU
#define CRESPO_A6_TDIO_SUSPENDED_CFG GPIO_IN_2M_PU

#define CRESPO_A6_MSM_IRQ_ACTIVE_CFG GPIO_IN_8M_PU
#define CRESPO_A6_MSM_IRQ_SUSPENDED_CFG GPIO_IN_2M_PU


/* a6 */
static struct msm_gpiomux_config msm8x60_a6_configs[] __initdata = {
	GPIOMUX_ACT_SUSP_DEF(CRESPO_A6_0_TCK, \
			CRESPO_A6_TCK_ACTIVE_CFG, CRESPO_A6_TCK_SUSPENDED_CFG),

	GPIOMUX_ACT_SUSP_DEF(CRESPO_A6_0_WAKEUP, \
			CRESPO_A6_WAKEUP_ACTIVE, CRESPO_A6_WAKEUP_SUSPENDED_CFG),

	GPIOMUX_ACT_SUSP_DEF(CRESPO_A6_0_TDIO, \
			CRESPO_A6_TDIO_ACTIVE_CFG, CRESPO_A6_TDIO_SUSPENDED_CFG),

	GPIOMUX_ACT_SUSP_DEF(CRESPO_A6_0_MSM_IRQ, \
			CRESPO_A6_MSM_IRQ_ACTIVE_CFG, CRESPO_A6_MSM_IRQ_SUSPENDED_CFG),
};
...
static struct msm_gpiomux_config msm8x60_aud_configs[] __initdata = {
	GPIOMUX_ACT_SUSP_DEF(CRESPO_AUD_LDO1_EN, \
			GPIO_OUTL_8M_PN, GPIO_OUTH_2M_PN),

	GPIOMUX_ACT_SUSP_DEF(CRESPO_AUD_LDO2_EN, \
			GPIO_OUTL_8M_PN, GPIO_OUTH_2M_PN),
};
#endif

struct msm_gpiomux_configs
crespo_gpiomux_cfgs[] __initdata = {
	...
	{msm8x60_proximity_i2c_cfgs,ARRAY_SIZE(msm8x60_proximity_i2c_cfgs)},
