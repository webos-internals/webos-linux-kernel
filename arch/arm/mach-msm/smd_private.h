...
/* To support 4725 modem baseline code, the structure
 * smsm_interrupt_info of SMD PKG3 is currently used,
 * since the additional members / size of SMD PKG4 is not
 * used anywhere
 * In future, if SMD PKG4's additional members / structure
 * size are used, this needs to be addressed by using the 
 * original SMD PKG4 structure
 */
