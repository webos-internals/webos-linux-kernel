 ...
 */
enum {
	PCOM_EFS_SYNC_EN = PCOM_PM_VID_EN,
	PCOM_PALM_DIAG_CMDS = PCOM_CUSTOMER_CMD1,
};
...
typedef enum
{
    ...
    PCOMM_PALM_DIAG_BKLT_CTL,
    PCOMM_PALM_DIAG_CONTROL_CHRG_V2,
    PCOMM_PALM_DIAG_RESET_CRCI_DBG,
    PCOMM_PALM_DIAG_MAX = 0xFF
} pcomm_palm_diag_cmds;

/*
 * This defines the desired backlight type. 
 */
typedef enum                                                                              
{ 
	PCOMM_PM_LCD_LED,
...
int proc_comm_backlight_control(pcomm_pm_led_type, int level);

/*
 * Pcomm for Palm charger commands (PCOMM_PALM_DIAG_CONTROL_CHRG_V2)
 */
typedef enum
{
	PCOMM_CHGR_BATT_FET_CTRL=0,
	PCOMM_CHGR_IMAX_SEL_CTRL,
	PCOMM_CHGR_VMAX_SEL_CTRL,
	PCOMM_CHGR_AUTO_CHG_CTRL,
	PCOMM_CHGR_TRCKL_CHG_CTRL,
	PCOMM_CHGR_TRCKL_IMAX_CTRL,
	PCOMM_CHGR_SRC_SEL_CTRL,
	PCOMM_CHGR_CMD_MAX,
} palm_chrg_cmd_v2_t;

int proc_comm_chrg_control_v2(palm_chrg_cmd_v2_t, int value);
