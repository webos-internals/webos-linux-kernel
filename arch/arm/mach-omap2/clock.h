...
#define MB_CM_CLKSEL1_PLL_19_VAL	MX_48M_SRC | MX_54M_SRC | MB_DPLL_DIV |\
					MB_DPLL_MULT | MX_APLLS_CLIKIN_19_2
...
/*
 * The Joplin's DDR SDRAM is rated to operate at 165, 133, and 104 MHz.
 * The Joplin has a 19.2 MHz reference clock.  Thus the possible frequencies
 * using 19.2 MHz reference (taken from x-load/board/joplin_ti/mem.c)
 *
 *  F_core = F_ref x  M / (N + 1)
 *         = 19.2  x  M / (N + 1)
 *
 *  F_core = 19.2 x 83 / (5 +1) =  265.6 Mhz ~ 266 MHZ
 *  F_core = 19.2 x 86 / (4 +1) =  330.2 Mhz ~ 330 MHZ
 */

/* Use 660.48 MHz instead of 660MHz, M=86 N=2.  This is what X-Load configures
   the DPLL for Brisket (aka Joplin). */
#define M2_DPLL_MULT_19		        (86 << 12)
#define M2_DPLL_DIV_19		        (4 << 8)
...
static struct prcm_config rate_table[] = {
	...
	{S19M, S660M, S330M, R1_CM_CLKSEL_MPU_VAL,		/* 330MHz ARM */
		R1_CM_CLKSEL_DSP_VAL, R1_CM_CLKSEL_GFX_VAL,
		R1_CM_CLKSEL1_CORE_VAL, M2_CM_CLKSEL1_PLL_19_VAL,
		MX_CLKSEL2_PLL_2x_VAL, R1_CM_CLKSEL_MDM_VAL,
		V24XX_SDRC_RFR_CTRL_165MHz, RATE_IN_243X },
	/* PRCM #2 - ratio1 (ES2) - SLOW */
	{S19M, S330M, S165M, R1_CM_CLKSEL_MPU_VAL,		/* 165MHz ARM */
		R1_CM_CLKSEL_DSP_VAL, R1_CM_CLKSEL_GFX_VAL,
		R1_CM_CLKSEL1_CORE_VAL, M2_CM_CLKSEL1_PLL_19_VAL,
		MX_CLKSEL2_PLL_1x_VAL, R1_CM_CLKSEL_MDM_VAL,
		V24XX_SDRC_RFR_CTRL_165MHz, RATE_IN_243X },
	/* PRCM-boot/bypass */
	{S19M, S19M, S19M, RB_CM_CLKSEL_MPU_VAL,		/* 19Mhz */
		RB_CM_CLKSEL_DSP_VAL, RB_CM_CLKSEL_GFX_VAL,
		RB_CM_CLKSEL1_CORE_VAL, MB_CM_CLKSEL1_PLL_19_VAL,
		MX_CLKSEL2_PLL_2x_VAL, RB_CM_CLKSEL_MDM_VAL,
		V24XX_SDRC_RFR_CTRL_BYPASS, RATE_IN_243X },
