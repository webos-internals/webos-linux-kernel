...
#define SDRC_SYSCONFIG_REG      0x010
#define SDRC_DLLA_CTRL_REG      0x060
#define SDRC_DLLA_STATUS_REG    0x064
#define SDRC_DLLB_CTRL_REG      0x068
#define SDRC_DLLB_STATUS_REG    0x06C
#define SDRC_POWER_REG          0x070
#define SDRC_MR_0_REG           0x084
