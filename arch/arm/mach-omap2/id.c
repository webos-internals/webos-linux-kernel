...
static struct omap_id omap_ids[] __initdata = {
	...
	{ .hawkeye = 0xb68a, .dev = 0x1, .type = 0x24301000 },
	{ .hawkeye = 0xb68a, .dev = 0x2, .type = 0x24302000 },
	{ .hawkeye = 0xb6d6, .dev = 0x0, .type = 0x34300000 },
	{ .hawkeye = 0xb7ae, .dev = 0x0, .type = 0x34301000 },
	{ .hawkeye = 0xb7ae, .dev = 0x1, .type = 0x34302000 },
};
...
//		prod_id, dev_type);
	...
	ctrl_status = omap_ctrl_readl(OMAP24XX_CONTROL_STATUS);
