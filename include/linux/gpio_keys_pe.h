...
#define OPT_CONSOLE_TRIGGER_EDGE (1 << 3)  // triggered by edge

#define OPT_DIAG_TRIGGER         (1 << 4)  // can be console switch trigger
#define OPT_DIAG_TRIGGER_EDGE    (1 << 5)  // triggered by edge
