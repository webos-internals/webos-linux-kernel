...
extern unsigned int omap3_rev(void);
extern unsigned int scalability_status;

/*
 * Get the CPU revision for OMAP devices
 */
#define GET_OMAP_REVISION()	((omap_rev() >> 12) & 0xf)
#define omap2_cpu_rev()		((omap_rev() >> 12) & 0xf)
...
#  define MULTI_OMAP1
# else
#  define OMAP1_NAME omap16xx
# endif
#endif

#ifdef CONFIG_ARCH_OMAP24XX
# if (defined(OMAP1_NAME) || defined(MULTI_OMAP1))
#  error "OMAP1 and OMAP2 can't be selected at the same time"
# else
#  define OMAP2_NAME omap24xx
# endif
#endif

#if defined(CONFIG_ARCH_OMAP34XX)
# if (defined(OMAP1_NAME) || defined(MULTI_OMAP1) || \
      defined(OMAP2_NAME) || defined(MULTI_OMAP2))
#  error "OMAP1 / OMAP2 / OMAP3 can't be selected at the same time"
# else
#  undef MULTI_OMAP3
#  define OMAP3_NAME omap34xx
# endif
#endif
...
#  error "OMAP1 / OMAP2 / OMAP3 can't be selected at the same time"
# else
#  if defined(OMAP3_NAME)
#    define MULTI_OMAP3
#    undef  OMAP3_NAME
#    define OMAP3_NAME omap3
#  else
#    define OMAP3_NAME omap36xx
#  endif
# endif
#endif
 ...
 */
#define GET_OMAP_CLASS	((omap_rev() >> 24)  & 0xff)
#define GET_OMAP3_CLASS	((omap3_rev() >> 24) & 0xff)
...
#define IS_OMAP3_CLASS(class, id)			\
static inline int is_omap ##class (void)		\
{							\
	return (GET_OMAP3_CLASS == (id)) ? 1 : 0;	\
}

#define GET_OMAP_SUBCLASS	((omap_rev() >> 20) & 0x0fff)
#define GET_OMAP3_SUBCLASS	((omap3_rev() >> 20) & 0x0fff)
...
#define IS_OMAP3_SUBCLASS(subclass, id)			\
static inline int is_omap ##subclass (void)		\
{							\
	return (GET_OMAP3_SUBCLASS == (id)) ? 1 : 0;	\
}
...
IS_OMAP3_CLASS(36xx, 0x36)

IS_OMAP_SUBCLASS(242x, 0x242)
IS_OMAP_SUBCLASS(243x, 0x243)
IS_OMAP_SUBCLASS(343x, 0x343)
IS_OMAP3_SUBCLASS(363x, 0x363)
...
#  define cpu_is_omap363x()		is_omap363x()
#  define cpu_is_omap36xx()		is_omap36xx()
# endif
#endif
...
#define GET_OMAP3_TYPE	((omap3_rev() >> 16) & 0xffff)
...
#define IS_OMAP3_TYPE(type, id)				\
static inline int is_omap ##type (void)			\
{							\
	return (GET_OMAP3_TYPE == (id)) ? 1 : 0;	\
}
...
#define is_sil_rev_greater_than(rev) \
		(((((omap_rev() & 0xffff0000) >> 16) == \
		((rev & 0xffff0000) >> 16))) && 	\
		(((omap_rev() & 0xf000) >> 12) > ((rev & 0xf000) >> 12)))
...
/*
 * Macros to detect silicon revision for 36xx
 * is_omap3_rev_greater_than:	true if passed cpu type & its rev is greater.
 * is_omap3_rev_lesser_than:	true if passed cpu type & its rev is lesser.
 * is_omap3_rev_equal_to:	true if passed cpu type & its rev is equal.
 * get_omap3_rev:		return the silicon rev value.
 */
#define is_omap3_rev_greater_than(rev) \
		(((((omap3_rev() & 0xffff0000) >> 16) == \
		((rev & 0xffff0000) >> 16))) && 	\
		(((omap3_rev() & 0xf000) >> 12) > ((rev & 0xf000) >> 12)))
#define is_omap3_rev_less_than(rev) \
		(((((omap3_rev() & 0xffff0000) >> 16) == \
		((rev & 0xffff0000) >> 16))) && 	\
		(((omap3_rev() & 0xf000) >> 12) < ((rev & 0xf000) >> 12)))
#define is_omap3_rev_equal_to(rev) \
		(((((omap3_rev() & 0xffff0000) >> 16) ==	\
		((rev & 0xffff0000) >> 16))) && \
		(((omap3_rev() & 0xf000) >> 12) == ((rev & 0xf000) >> 12)))
#define get_omap3_rev() \
		((omap3_rev() & 0xf000) >> 12)
...
#define OMAP363X_CLASS		0x36300000
#define OMAP3630_REV_ES1_0	0x36300000 
#define OMAP3630_REV_ES1_1	0x36301000
#define OMAP3630_REV_ES1_2	0x36302000
...
#define get_omap3_device_type() \
		((omap3_rev() & 0x700) >> 8)
#define is_omap3_device_type_test() \
		(get_omap3_type() == DEVICE_TYPE_TEST)
#define is_omap3_device_type_emu() \
		(get_omap3_device_type() == DEVICE_TYPE_EMU)
#define is_omap3_device_type_sec() \
		(get_omap3_device_type() == DEVICE_TYPE_SEC)
#define is_omap3_device_type_gp() \
		(get_omap3_device_type() == DEVICE_TYPE_GP)
#define is_omap3_device_type_bad() \
		(get_omap3_device_type() == DEVICE_TYPE_BAD)
