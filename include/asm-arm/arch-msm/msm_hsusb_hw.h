...
#define OTG_BSEIE             (1 << 28) /* B session end IE */
#define OTG_BSVIE             (1 << 27) /* B session valid IE */
#define OTG_BSEIS             (1 << 20) /* B session end IS */
#define OTG_BSVIS             (1 << 19) /* B session valid IS */
