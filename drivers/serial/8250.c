...
static int size_fifo(struct uart_8250_port *up)
{
#ifdef CONFIG_ARCH_OMAP34XX
	/* 
	 * The code below does not work correctly on 3430 and 
	 * it is even more broken on 3630. Let's just bypass it altogether.
	 */
	return 64;
#else
	...
	for (count = 0; count < 256; count++)
		if (serial_inp(up, UART_LSR) & (1<<5)) /* TX FIFO empty */
