...
#define	OMAP_TLL_CHANNEL_CONF(num)\
	...
	#define OMAP_TLL_CHANNEL_CONF_TLLFULLSPEED_SHIFT	6
	#define OMAP_TLL_CHANNEL_CONF_TLLCONNECT_SHIFT		5
	#define OMAP_TLL_CHANNEL_CONF_TLLATTACH_SHIFT		4
	#define OMAP_TLL_CHANNEL_CONF_UTMIISADEV_SHIFT		3
