...
int msm_camio_clk_enable(enum msm_camio_clk_type clktype)
{
	...
	case CAMIO_VFE_CLK:
		...
		msm_camio_clk_rate_set_2(clk, camio_clk.vfe_clk_rate ? camio_clk.vfe_clk_rate :
			150000000);
		break;
	...
	case CAMIO_CAM_MCLK_CLK:
		...
		msm_camio_clk_rate_set_2(clk, camio_clk.mclk_clk_rate ? camio_clk.mclk_clk_rate :
			24000000);
		break;
