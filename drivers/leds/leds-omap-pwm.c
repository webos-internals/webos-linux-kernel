...
static ssize_t omap_pwm_led_on_period_show(struct device *cdev, 
...
static ssize_t omap_pwm_led_on_period_store(struct device *cdev,
					    struct device_attribute *attr,
...
static ssize_t omap_pwm_led_off_period_show(struct device *cdev, 
					    struct device_attribute *attr,
					    char *buf)
{
	struct led_classdev *led_cdev = dev_get_drvdata(cdev);
...
static ssize_t omap_pwm_led_off_period_store(struct device *cdev, 
					     struct device_attribute *attr,
					     const char *buf, size_t size)
{
	struct led_classdev *led_cdev = dev_get_drvdata(cdev);
