...
#define OUTPUT_PREDRIV				 (DIR_OUT | (1 << 5))
...
#define DEFAULT_OUTPUT_PRED_VOLUME		 70
...
struct twl_local_info {
	...
	u16 predrv_vol; /* store the predriv volume */
};
static struct twl_local_info twl4030_local = {
	...
	.mod_cnt = 0,
	.predrv_vol = WRITE_LR_VOLUME(DEFAULT_OUTPUT_PRED_VOLUME),
};
