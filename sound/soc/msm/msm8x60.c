...
#elif defined(CONFIG_MACH_SHORTLOIN)

static const struct snd_soc_dapm_widget shortloin_dapm_widgets[] = {
        SND_SOC_DAPM_HP("Headphone", NULL),
        SND_SOC_DAPM_MIC("Headset Mic", NULL),
        SND_SOC_DAPM_MIC("Internal Mic", NULL),
        SND_SOC_DAPM_SPK("Speaker",wm8994_en_pwr_amp),
...
static struct snd_soc_dapm_route shortloin_dapm_routes[] = {
        { "Headphone",  NULL, "HPOUT1L" },
        { "Headphone",  NULL, "HPOUT1R" },
...
#elif defined (CONFIG_MACH_CRESPO)
static const struct snd_soc_dapm_widget crespo_dapm_widgets[] = {
        SND_SOC_DAPM_HP("Headphone", NULL),
        SND_SOC_DAPM_MIC("Headset Mic", NULL),
        SND_SOC_DAPM_MIC("Internal Mic", NULL),
        SND_SOC_DAPM_SPK("Speaker",wm8994_en_pwr_amp),
...
static struct snd_soc_dapm_route crespo_dapm_routes[] = {
        { "Headphone",  NULL, "HPOUT1L" },
        { "Headphone",  NULL, "HPOUT1R" },
...
#elif defined(CONFIG_MACH_SHORTLOIN)
	snd_soc_dapm_new_controls(codec, shortloin_dapm_widgets,
                                ARRAY_SIZE(shortloin_dapm_widgets));

        snd_soc_dapm_add_routes(codec, shortloin_dapm_routes,
                                ARRAY_SIZE(shortloin_dapm_routes));
#elif defined (CONFIG_MACH_CRESPO)
	snd_soc_dapm_new_controls(codec, crespo_dapm_widgets,
                                ARRAY_SIZE(crespo_dapm_widgets));

        snd_soc_dapm_add_routes(codec, crespo_dapm_routes,
                                ARRAY_SIZE(crespo_dapm_routes));
#endif
