...
/* flag indicating whether the system is in fastpath or not */
static int fastsleep_flag;
...
/**
 * @brief Return whether the system is in fastpath or not
 * 
 * @retval 1 if the system is in fastpath, 0 otherwise
 */
int fastpath_fastsleep_get(void)
{
	return fastsleep_flag;
}

/**
 * @brief Set whether the system is in fastpath or not
 */
